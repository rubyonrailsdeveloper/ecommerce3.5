...
ActiveRecord::Schema.define(version: 20190119084144) do
  ...
  create_table "spree_marketing_contacts", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", default: "2019-01-19 08:41:38", null: false
    t.datetime "updated_at", default: "2019-01-19 08:41:38", null: false
    t.integer "user_id"
